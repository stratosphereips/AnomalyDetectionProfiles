...
class DashboardTests(unittest.TestCase):
    ...
    def test_learning_guide_is_self_contained_and_served_by_dashboard(self):
        ...
        self.assertIn("Concrete definition:", guide)
        self.assertIn("What does “dispersion” mean, and dispersion of what?", guide)
        self.assertIn("residuals = [0.02, 0.04, 0.03, 0.05, 0.02]", guide)
        self.assertIn("Interactive noise-floor calculation", guide)
        self.assertIn("updateFloorCalculator", guide)
