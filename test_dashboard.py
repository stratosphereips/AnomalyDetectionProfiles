...
class DashboardTests(unittest.TestCase):
    ...
    def test_learning_guide_is_self_contained_and_served_by_dashboard(self):
        ...
        self.assertIn("These two bucket types do not receive the same converted features", guide)
        self.assertIn("One record, two conversions", guide)
        self.assertIn("Destination-IP vectors: a different fixed schema", guide)
